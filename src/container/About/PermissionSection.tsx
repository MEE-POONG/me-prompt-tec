    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="mt-8">
            <a href="/contact" className="inline-block bg-blue-500 text-white px-8 py-3 rounded-2xl font-semibold hover:bg-yellow-500  border-2 border-white/20 transition-all duration-300 hover:scale-110">
              ติดต่อเรา
            </a>
          </div>
        </div>
