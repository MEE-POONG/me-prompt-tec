        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="text-slate-500 hover:text-purple-600 transition-all duration-200 hover:translate-x-1 flex items-center gap-1 group"
                  >
                    <ArrowRight
                      size={12}
                      className="opacity-0 group-hover:opacity-100 -ml-3 group-hover:ml-0 transition-all duration-200"
                    />
                    {item.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500">
              <li className="hover:text-purple-600 transition-colors cursor-default">
                Web Development
              </li>
              <li className="hover:text-purple-600 transition-colors cursor-default">
                Mobile Application
          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              <a
                href="#"
                className="p-2 bg-white border border-slate-200 rounded-full text-slate-400 hover:text-purple-600 hover:border-purple-200 hover:bg-purple-50 transition-all shadow-sm"
              >
                <Linkedin size={18} />
              </a>
              <a
                href="#"
                className="p-2 bg-white border border-slate-200 rounded-full text-slate-400 hover:text-slate-900 hover:border-slate-300 hover:bg-slate-100 transition-all shadow-sm"
              >
                <Github size={18} />
              </a>
              <a
                href="#"
                className="p-2 bg-white border border-slate-200 rounded-full text-slate-400 hover:text-purple-700 hover:border-purple-300 hover:bg-purple-50 transition-all shadow-sm"
              >
                <Facebook size={18} />
              </a>
            </div>
